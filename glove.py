...
def loss(w, b, w_c, b_c, c, xmax = 100.0, alpha=0.75):
    ...
    print w_c
    print w
    inner = tf.reduce_sum(w * w_c, reduction_indices=[1]) + b + b_c - tf.log(c)
    weights = example_weight(c, xmax, alpha)
    return weights * inner * inner
